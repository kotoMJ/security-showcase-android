...
class LoginBiometricFragment : BaseFragmentViewModel<LoginBiometricViewModel, FragmentLoginBinding>() {
//	override val baseActivity: BaseActivity
//		get() = TODO("not implemented") //To change initializer of created properties use File | Settings | File Templates.

	override fun setupViewModel() = findViewModel<LoginBiometricViewModel>()
